...
const ManageEmployeeRole = lazy(() =>
  import("./pages/admin/ManageEmployeeRole/ManageEmployeeRole")
);
...
const AddEmployee = lazy(() =>
  import("./pages/admin/SheporaEmployeeManagement/AddEmployee")
);

const Login = lazy(() => import("./pages/login/Login"));
const HarvestAdd = lazy(() =>
  import("./pages/admin/harvest_manager/HarvestAdd")
);
const Table = lazy(() => import("./pages/admin/harvest_manager/Harves_table"));
const ResourceInventory = lazy(() =>
  import("./pages/admin/ManageInventory/ResourceInventory")
);
const SalesInventory = lazy(() =>
  import("./pages/admin/ManageInventory/SalesInventory")
);
...
const Delivery = lazy(() =>
  import("./pages/admin/packinganddelivery/Delivery")
);
const Salary = lazy(() => import("./pages/admin/Salary/Salary"));
const InventoryStuff = lazy(() =>
  import("./pages/admin/InventoryStuff/InventoryStuff")
);
...
const PlantReports = lazy(() =>
  import("./pages/admin/PlantSchedule/PlantReport")
);
